...
orderedlist     = [
	...
	'cS','SIGX','SEPX','SEPXSIGX1','SEPXSIGX2','SEPXSIGY1','SEPXSIGY2','SIGY','SEPY',
	'SEPYSIGX1','SEPYSIGX2','SEPYSIGY1','SEPYSIGY2','SEPR','SEPRSIGXY1','SEPRSIGXY2',
	'SIGX2','SIGY2','BBDPX','BBDPY','BBDQX','BBDQY'     
	]
...
def TableToMfs(table,tfssummary,bunchcharge,orderedlist):
	mfs = 'mfs[{'
	for k in tfssummary:
	...
	mfs += '{"BUNCHCHARGE2",'+ str(bunchcharge) + '}'
	mfs += '},{'
...
file.write(TableToMfs(rb1,datab1[1],bunchch,orderedlist))
file.close()

print rb1['SIGX']
print len(datab1[0]['s'])
print len(bbdqy)
